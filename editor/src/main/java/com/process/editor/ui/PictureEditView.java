...
import com.process.editor.EditMode;
import com.process.editor.PictureEditor;
import com.process.editor.anim.EditAnimator;
import com.process.editor.bean.DrawPen;
import com.process.editor.bean.EditState;
import com.process.editor.bean.StickerText;
import com.process.editor.clip.EditClipWindow;
import com.process.editor.IEditSave;
import com.process.editor.sticker.IStickerParent;
import com.process.editor.ui.sticker.ImageStickerView;
import com.process.editor.ui.sticker.StickerView;
import com.process.editor.ui.sticker.TextStickerView;
import com.process.editor.ui.widget.ColorRadio;
...
public class PictureEditView extends FrameLayout implements Runnable, ScaleGestureDetector.OnScaleGestureListener,
    ...
    public boolean saveEdit(@NonNull IEditSave callback) {
        return saveEdit(callback, null);
    }

    public boolean saveEdit(@NonNull IEditSave callback, String targetDir) {
        Bitmap bitmap = getBitmap();
        if (bitmap != null) {
            String savePath;
            if (targetDir != null && !targetDir.isEmpty()) {
                savePath = Utils.saveBitmapToDir(getContext(), bitmap, targetDir);
            } else {
                savePath = Utils.saveBitmap(getContext(), bitmap);
            }
